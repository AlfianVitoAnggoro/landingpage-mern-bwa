    ...
    <>
      ...
      <section className="bg-navy">
        <div className="checkout container">
          ...
          {data.map((data) => (
            <div className="event-details container d-flex flex-wrap justify-content-lg-center align-items-center gap-5" key={data._id}>
              ...
              <div className="total-price">{data.totalPay === 0 ? 'free' : `$${data.totalPay}`}</div>
            </div>
          ))}
        </div>
      </section>
