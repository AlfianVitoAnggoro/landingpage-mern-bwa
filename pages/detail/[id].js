  ...
  return (
    <>
      ...
      <div className="preview-image bg-navy text-center">
        <img src="/images/details-image.png" className="img-content" alt="semina" />
      </div>
        ...
        <div className="d-flex flex-wrap justify-content-lg-center gap">
          ...
          <div className="d-flex flex-column card-event">
            ...
            <div className="d-flex align-items-center gap-3 mt-3">
              <img src={`${process.env.NEXT_PUBLIC_API}/${detailPage?.talent?.image?.name}`} alt="semina" width="60" />
              <div>
                ...
                {ticket.statusTicketCategories ? (
                  <>
                    ...
                    <div className="d-flex gap-3 align-items-center card-details">
                      <img src="/icons/ic-marker.svg" alt="semina" /> {detailPage.venueName}
                    </div>
                    <div className="d-flex gap-3 align-items-center card-details">
                      <img src="/icons/ic-time.svg" alt="semina" /> {moment(detailPage.date).format('HH.MM A')}
                    </div>
                    <div className="d-flex gap-3 align-items-center card-details">
                      <img src="/icons/ic-calendar.svg" alt="semina" /> {formatDate(detailPage.date)}
                    </div>

                    {detailPage.stock !== 0 && (
                      <Button variant={'btn-green'} action={() => handleSubmit(ticket._id, detailPage.organizer)}>
                        Join Now
                      </Button>
                    )}
                  </>
